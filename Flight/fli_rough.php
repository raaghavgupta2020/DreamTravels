...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="http://localhost/Dreamtravels/Home.php" class="w3-bar-item w3-button w3-padding-large w3-theme-d4"><i class="fa fa-home w3-margin-right"></i>Home</a>
   ...
   <a href="http://localhost/Dreamtravels/Hotel%20page/hotel_search.php" class="w3-button w3-padding-large"><i class="fa fa-hotel w3-margin-right"></i>Hotel Search</a>
   <a align="center" class="w3-bar-item w3-padding-large">Welcome &nbsp;<?php echo $_SESSION['name'];?></a>
  
  
  <div class="w3-dropdown-hover w3-hide-small">
    <button class="w3-button w3-padding-large" title="History">Booking History</button>     
...
?><br /><br>
      ...
      <div class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
        <h3>Booking Flights with Dream Travels</h3>

<p>Book your flights tickets with India’s leading flight booking company since the year 2000.
 While booking flights with DreamTravels, you can expect the ultimate online booking experience. </p>
 <p>With premium customer service, 24/7 dedicated helpline for support, and over 5 million delighted customers, 
DreamTravels takes great pride in enabling customer satisfaction.
  ...
  <div class="container">
  <img src="flight1.jpg" alt="Flight Image" style="width:100% ;">
</div>
      </div>  
        </div> 
